...
# online 218
# url = "http://118.31.250.218:6033/api/email/email_creditScore/v1.0"

# online 129
url = "http://120.27.195.129:6033/api/email/email_creditScore/v1.0"

# local server
#url = "http://0.0.0.0:6033/api/email/email_creditScore/v1.0"

# campany server
# url = "http://192.168.0.58:23/api/email/email_creditScore/v1.0"
