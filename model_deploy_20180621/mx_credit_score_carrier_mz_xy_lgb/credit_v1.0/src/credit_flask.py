...
@app.route('/api/carrier_mz_xy/risk/score/v1.0',methods=['POST'])
def access_model_predict():
    ...
    try:
        ...
        result,errorMsg,returnCode = predict_flask(data_df,'lgb_30_v1.0_new',feature_final,path,load_IndependModel,LOG,mx_scores,errorMsg = '')
