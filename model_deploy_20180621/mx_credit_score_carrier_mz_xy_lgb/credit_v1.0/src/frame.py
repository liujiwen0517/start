...
path = abspath(join(dirname(__file__),'..','..','..','mx_credit_score_carrier_mz_xy_lgb'))
...
tag 0   1   bad_rate
score_cut           
(350, 500]  578 890 0.606267
(500, 550]  552 378 0.406452
(550, 600]  647 281 0.302802
(600, 650]  545 173 0.240947
(650, 700]  379 72  0.159645
(700, 800]  213 35  0.141129
(800, 900]  11  1   0.083333


score_line ≥ 650  pass_rate = 15% bad_rate = 15%
...
def model_preditc(df,model,feature_final,LOG,mx_scores):
    try:
        y_predprob = model.predict_proba(df[feature_final].values)[:, 1]
